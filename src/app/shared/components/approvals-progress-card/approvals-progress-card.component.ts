...
@Component({
  selector: 'app-approvals-progress-card',
  templateUrl: './approvals-progress-card.component.html',
  styleUrl: './approvals-progress-card.component.scss'
})
export class ApprovalsProgressCardComponent {
