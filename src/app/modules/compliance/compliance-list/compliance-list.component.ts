...
@Component({
  ...
  styleUrl: './compliance-list.component.scss'
})
   ...
   dataList: Data[] = [
      {
        ...
        description:
          'Create a design system for a hero section in 2 different varinats. Create a simple designs that will create impact.',
        status: 'inProcess',
        priority: 'high',
